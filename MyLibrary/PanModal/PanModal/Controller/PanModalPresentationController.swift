...
private extension PanModalPresentationController {
    ...
    func addDragIndicatorView(to view: UIView) {
        ...
        NSLayoutConstraint.activate([
            dragIndicatorView.bottomAnchor.constraint(equalTo: presentedView.topAnchor, constant: -Constants.indicatorYOffset),
            dragIndicatorView.centerXAnchor.constraint(equalTo: presentedView.centerXAnchor),
