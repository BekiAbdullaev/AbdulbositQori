...
//  Abdulbosit Qori
//
//  Created by Bekzod Abdullaev on 4/17/23.
//
...
class SegmentedProgressBar: UIView {
    ...
    override func layoutSubviews() {
        ...
        for (index, segment) in segments.enumerated() {
            ...
            let segMinFrame = CGRect(x: CGFloat(index) * (width + padding), y: 4, width: width, height: frame.height-8)
            
            segment.bottomSegmentView.frame = segMinFrame
